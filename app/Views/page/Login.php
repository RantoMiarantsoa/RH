    ...
    <div class="auth-page geo-bg">
      <div class="auth-split">
        ...
        <div class="auth-right">
          ...
          <form method="post" action="<?= site_url('employe/connexion'); ?>" class="auth-form">
            <div class="f-group">
              <label class="f-label">Adresse email</label>
              <input type="email" name="email" class="f-input" placeholder="vous@techmada.mg" value="marie.rabe@rh.com" />
            </div>
            <div class="f-group">
              <label class="f-label">Mot de passe</label>
              <input type="password" name="password" class="f-input" placeholder="••••••••" value="1234" />
            </div>
